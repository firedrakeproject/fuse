...
class ElementTriple():
    ...
    def _entity_associations(self, dofs):
        ...
        for d in dofs:
            ...
            # d.cell_defined_on.id - min_ids[sub_dim]
            sub_dict = entity_associations[sub_dim][self.cell.d_entities_ids(sub_dim).index(d.cell_defined_on.id)]
                    ...
                    for dof_gen in entity_associations[dim][e_id].keys():
                        ...
                        if not len(dof_gen_class[dim].g2.members()) == 1 and dim == min(dof_gen_class.keys()):
                            ...
                            if len(ent_dofs_ids) == basis_change.shape[0]:
                                ...
                                sub_mat = np.kron(sub_mat1, value_change)
